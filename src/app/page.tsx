...
import { AcademicCapIcon, UserGroupIcon, CodeBracketIcon, BookOpenIcon, ChatBubbleOvalLeftEllipsisIcon } from "@heroicons/react/24/solid";
  ...
  return (
    <main className="overflow-x-hidden">
      ...
      <section className="min-h-screen flex flex-col justify-center items-center px-6 text-center bg-white dark:bg-gray-900">
        <h1 className="text-5xl font-bold mb-6 text-blue-600">What is FluentDev?</h1>
        <p className="max-w-3xl text-xl text-gray-700 dark:text-gray-300">
          ...
          We combine essential blockchain knowledge with real-world English communication skills, empowering you to thrive in global blockchain teams.
        </p>
      </section>
      ...
      <section className="min-h-screen flex flex-col justify-center items-center px-6 text-center bg-gray-50 dark:bg-gray-800">
        <h2 className="text-4xl font-semibold mb-12 text-blue-600">Who is fluentDev for?</h2>
        ...
        <div className="flex flex-col md:flex-row gap-10 max-w-5xl justify-center">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-lg shadow-md p-8 max-w-sm mx-auto">
            ...
            <p className="text-gray-700 dark:text-gray-300">
              Improve your technical English to clearly explain smart contracts, DeFi protocols, and blockchain infrastructure — all in a Web3 context.
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-lg shadow-md p-8 max-w-sm mx-auto">
            ...
            <p className="text-gray-700 dark:text-gray-300">
              From DAO leads to product managers and grant writers — build confidence communicating with global teams, investors, and communities.
            </p>
          </div>
      ...
      <section className="min-h-screen flex flex-col justify-center items-center px-6 text-center bg-white dark:bg-gray-900">
        <h2 className="text-4xl font-semibold mb-8 text-blue-600">Explore Our Courses</h2>
        <div className="max-w-4xl grid md:grid-cols-2 gap-10">
          ...
          <div className="bg-gray-100 dark:bg-gray-800 rounded-lg shadow-md p-8">
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-4">
              Learn grammar structures and Web3 vocabulary in context, with scenario-based lessons and interactive practice.
            </p>
            <Link href="/glossary" className="inline-block text-blue-600 hover:underline font-semibold">
              View Glossary →
            </Link>
          </div>
        </div>
      ...
      {/* Section 4: Glossary */}
      <section className="min-h-screen flex flex-col justify-center items-center px-6 text-center bg-gray-50 dark:bg-gray-800">
        <h2 className="text-4xl font-semibold mb-8 text-blue-600">Blockchain Glossary</h2>
        <p className="max-w-3xl text-lg text-gray-700 dark:text-gray-300 mb-8">
          Quickly understand key blockchain and Web3 terms with clear, learner-friendly definitions and examples.
          Perfect for brushing up your technical vocabulary before meetings or presentations.
        </p>
        <Link href="/glossary" className="bg-gray-800 hover:bg-gray-900 text-white px-8 py-4 rounded-lg font-semibold transition">
          Browse Glossary
        </Link>
      </section>
